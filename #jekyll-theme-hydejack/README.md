...
## A Printable Resume
Get a resume that's consistent across the board — whether it's on the web, mobile, print, or [PDF](https://ypit.github.io/assets/resume.pdf).

[![Resume PDF](https://jypit.github.io/assets/img/blog/resume.png)][resume]
